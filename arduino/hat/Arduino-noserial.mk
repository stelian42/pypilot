...
ifeq ($(strip $(NO_CORE)),)
	...
	#$(error XXX $(CORE1_CPP_SRCS))
	CORE_CPP_SRCS := $(subst $(ARDUINO_CORE_PATH)/HardwareSerial.cpp,,$(CORE_CPP_SRCS))
	CORE_CPP_SRCS := $(subst $(ARDUINO_CORE_PATH)/HardwareSerial0.cpp,,$(CORE_CPP_SRCS))
	CORE_CPP_SRCS := $(subst $(ARDUINO_CORE_PATH)/HardwareSerial1.cpp,,$(CORE_CPP_SRCS))
	CORE_CPP_SRCS := $(subst $(ARDUINO_CORE_PATH)/HardwareSerial2.cpp,,$(CORE_CPP_SRCS))
	CORE_CPP_SRCS := $(subst $(ARDUINO_CORE_PATH)/HardwareSerial3.cpp,,$(CORE_CPP_SRCS))
	#$(warning XXX $(CORE_CPP_SRCS))
